...
sections:
  - type: GenericSection
    title:
      text: Streamline Your Operations & Maximize Savings
      color: text-dark
      type: TitleBlock
    subtitle: ''
    text: >
    ...
    media:
      ...
      type: ImageBlock
    badge:
      label: Unlock Your Energy Potential
      color: text-primary
      type: Badge
    elementId: ''
    ...
    title:
      ...
      styles:
        self:
          textAlign: center
      type: TitleBlock
    subtitle: Driving Value & Efficiency in Energy Management
    items:
      - type: FeaturedItem
        title: 500k
      ...
      - title: 20x
        ...
        text: >+
          Gain actionable energy insights and market data 20x faster, empowering
